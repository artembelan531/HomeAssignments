...
#include "autobot.h"
Autobot::Autobot() : Transformer(),_motto("Here we go!"), _have_a_matrix_of_leadership(true) {}
Autobot::Autobot(std::string name) : Transformer(name),_motto("Here we go!"), _have_a_matrix_of_leadership(true) {}
...
{
    std::cout << "Method transform called from Autobot." << std::endl;
}
void Autobot::openFire()
{
    std::cout << "Method openFire called from Autobot." << std::endl;
}
void Autobot::ulta()
{
    std::cout << "Method ulta called from Autobot." << std::endl;
}
